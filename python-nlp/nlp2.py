...
# this all succeeds if you see the text of your files printed in the console.
        ...
        sorted_highSimilarityReduced = sorted(highSimilarityReduced.items(), key=lambda x:x[1], reverse=True)
        dict_sort_highSimilarityReduced = dict(sorted_highSimilarityReduced)
        print(dict_sort_highSimilarityReduced)
        ...
        # ws: Sorted needs to be in reverse to show highest to lowest.
